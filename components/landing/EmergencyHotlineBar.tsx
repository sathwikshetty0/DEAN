...
export const EmergencyHotlineBar = () => (
  <div aria-label="Emergency Hotlines Bar" role="contentinfo" className="fixed bottom-0 left-0 right-0 z-40 border-t border-[var(--border-default)] bg-[var(--bg-primary)]/95 backdrop-blur-md px-4 py-2 hidden md:block">
